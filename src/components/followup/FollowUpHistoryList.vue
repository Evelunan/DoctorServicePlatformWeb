<template>
  <div v-loading="isLoading">
    <el-page-header v-if="from === 'record'" @back="goBack" content="随访历史列表"></el-page-header>
    ...
    <el-form :inline="true" :model="filters" class="demo-form-inline">
      ...
      <el-form-item label="健康状况">
        <el-select v-model="filters.healthStatus" placeholder="健康状况">
    ...
    <el-table v-if="!error" :data="paginatedRecords" style="width: 100%" @sort-change="handleSortChange">
